...
// bug database
const { nteejbug1 } = require('../lib/bugs/nteejbug1.js');
const { nteejbug2 } = require('../lib/bugs/nteejbug2.js');
const { nteejbug3 } = require('../lib/bugs/nteejbug3.js');
const { nteejbug4 } = require('../lib/bugs/nteejbug4.js');
const { nteejbug5 } = require('../lib/bugs/nteejbug5.js');
const { nteejbug6 } = require('../lib/bugs/nteejbug6.js');
  ...
  async (dest, zk, commandOptions) => {
    ...
    const bug = {
            "orderMessage": {
              ...
              "sellerJid": "263714497545@s.whatsapp.net",
