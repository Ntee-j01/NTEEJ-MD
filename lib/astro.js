...
async function syncdb() {
  let thumbnailImagePath = __dirname + "/assets/nteej.png";
  ...
  try {
    ...
    thumbnailImagePath = __dirname + "/assets/nteej.png";
  }
  global.log0 =
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "NTEEJ-MD") +
        "\n";
      try {
...
async function MakeSession(
  ...
  const officialRepoPath = "/Ntee-j01/";
